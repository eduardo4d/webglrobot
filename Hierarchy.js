...
/**  @type {Matrix4} */
var shoulderMatrix2 = new Matrix4()
    .setTranslate(-6.5, 2, 0)
    .translate(0, 2, 0)
    .rotate(-joint.shoulder, 1, 0, 0)
    .translate(0, -2, 0);
...
var legMatrix2 = new Matrix4()
    .setTranslate(-2, -9, 0)
    .rotate(joint.leg, 0, 1, 0);
var kneeMatrix = new Matrix4()
    .setTranslate(0, -5, 0)
    .rotate(joint.knee, 0, 1, 0);
...
function handleKeyPress(event) {
    ...
    switch (ch) {
        ...
        case "g":
            ...
            legMatrix2.setTranslate(-2, -9, 0).multiply(currentLegRot);
            break;
        case "G":
            joint.leg -= 15;
            var currentLegRot = new Matrix4()
...
function draw(useRotator = true) {
    ...
    s.push(new Matrix4(s.top()).multiply(legMatrix2));
    renderCube(s, legMatrixLocal, 3);
